...
import { DocumentArrowDownIcon, SparklesIcon, ArrowPathIcon, CircleStackIcon, XCircleIcon } from './icons/Icons';
...
const UploadData: React.FC = () => {
    ...
    const handleAnalyze = async () => {
        ...
        setAnalysisResult(null);
        try {
            const result = await analyzeCsvDataWithPrompt(csvString, userPrompt);
